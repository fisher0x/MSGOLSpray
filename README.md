# MSGOLSpray — Fast, reliable Go CLI for O365 / EntraID account testing

Go-based port of [MSOLSpray](https://github.com/dafthack/MSOLSpray/tree/master) tool with enhanced features, including single-name account brute-forcing and credential pair checking. Designed for speed, simplicity, and reliability, it helps security professionals test Microsoft account resilience efficiently.

[![Go](https://img.shields.io/badge/Go-1.21+-00ADD8?style=flat&logo=go)](https://golang.org/)
[![License](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Platform](https://img.shields.io/badge/Platform-Windows%20%7C%20Linux%20%7C%20macOS-lightgrey)](https://github.com)
[![Release](https://img.shields.io/github/v/release/fisher0x/MSGOLSpray?include_prereleases)](https://github.com/fisher0x/MSGOLSpray/releases)
...
MSGOLSpray is a lightweight Go CLI focused on automated assessment of Microsoft account authentication. It emphasizes clarity, portability, and predictable behavior across platforms.
...
```bash
go install github.com/fisher0x/msgolspray/cmd/msgolspray/@latest
```

### Pre-built Binaries

Download the latest release for your platform from the [Releases](https://github.com/fisher0x/MSGOLSpray/releases) page:

Available binaries:
- `MSGOLSpray_linux_amd64` - Linux 64-bit
- `MSGOLSpray_linux_arm64` - Linux ARM64
- `MSGOLSpray_darwin_amd64` - macOS Intel
- `MSGOLSpray_darwin_arm64` - macOS Apple Silicon
- `MSGOLSpray_windows_amd64.exe` - Windows 64-bit
...
**Build:**
```bash
git https://github.com/fisher0x/MSGOLSpray.git
cd MSGOLSpray
go build -o MSGOLSpray .
./MSGOLSpray --help
```
...
MSGOLSpray: Multi-threaded O365/Azure password spray tool
Usage examples:
...
Flags:
  ...
  -o, --output [dir]       Output file for successful results (JSON). If a directory or '.' is specified, saves as YYYY-MM-DD_HH-MM-SS_MSGOLSpray.json in that location.
...
MSGOLSpray provides different result types:
